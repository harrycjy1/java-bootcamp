...
public class WrapperExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("문자열 “-123”을 정수로 변환하여 출력 : "+ Integer.parseInt("-123"));
		String a=Integer.toHexString(10);
		System.out.println("16진수로 표현된 문자열 “10”을 정수로 변환하여 출력 : "+Integer.parseInt(a,16));
		...
		System.out.println("d값(=3.1234566)을 문자열로 변환하여 출력 : "+Double.valueOf(d));
